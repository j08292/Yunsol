		...
		<div class="container clearfix">
			...
			<div id="logo">
				<a href="${pageContext.request.contextPath}/main/main.do"
					class="standard-logo"
					data-dark-logo="${pageContext.request.contextPath}/resources/user/images/logo-dark_2.png"><img
					src="${pageContext.request.contextPath}/resources/user/images/logo_2.png"
					alt="Canvas Logo"></a> <a
					href="${pageContext.request.contextPath}/main/main.do"
					class="retina-logo"
					data-dark-logo="${pageContext.request.contextPath}/resources/user/images/logo-dark@2x_2.png"><img
					src="${pageContext.request.contextPath}/resources/user/images/logo@2x_2.png"
					alt="Canvas Logo"></a>
			</div>
			<!-- #logo end -->
